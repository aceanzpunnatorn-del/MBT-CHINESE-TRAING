              ...
              <div className="relative z-10 p-6 sm:p-8 md:p-9">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="flex h-13 items-center rounded-2xl border border-white/55 bg-white/55 px-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.65)] backdrop-blur-md transition focus-within:border-[#6ABFE7]">
                  ...
                  <button
                    ...
                    className="group flex h-13 w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-[#2EA7E0] to-[#1D8FC7] px-4 py-3 text-base font-semibold text-white shadow-[0_14px_30px_rgba(46,167,224,0.32)] transition duration-200 hover:translate-y-[-1px] hover:shadow-[0_18px_36px_rgba(29,143,199,0.36)]"
                  >
